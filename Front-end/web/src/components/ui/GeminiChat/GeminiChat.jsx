...
function GeminiChat({ model, handleModelSelect }) {
  ...
  const speakText = (text) => {
    if ('speechSynthesis' in window) {
      ...
      utterance.lang = 'en-US'; // Changed to English for Gemini
      utterance.rate = 0.9;
      utterance.pitch = 1;
  ...
  return (
    <div
      className={cx('gemini-chat', { 'drag-over': isDragOver })}
      ...
      <div className={cx('chat-container')}>
        ...
        {typing && currentTypingMessage && (
          <div className={cx('messages-container')}>
            <img src='/images/icon_Bot.png' alt='gemini' />
            <div className={cx('messages')}>
